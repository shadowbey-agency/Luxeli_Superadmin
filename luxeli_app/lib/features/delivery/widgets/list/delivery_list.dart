...
import 'package:luxeli_app/features/delivery/widgets/list/delivery_request_card.dart';
  ...
  Widget build(BuildContext context) {
    return Consumer<DeliveryProvider>(
      builder: (context, provider, child) {
        final List<DeliveryRequest> requests = provider.deliveryRequests;

        if (requests.isEmpty) {
          return _buildNoRequestsState();
        }

        final Map<String, List<DeliveryRequest>> groupedRequests = {};
          ...
          itemBuilder: (context, index) {
            ...
            return Column(
              ...
              children: [
                ...
                ...requestsForDate.map(
                  (request) => DeliveryRequestCard(request: request),
                ),
              ],
            );
          },
