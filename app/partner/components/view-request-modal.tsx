        ...
        <div className="flex-1 p-5 overflow-y-auto">
          <div className="flex flex-col gap-3">
            ...
            <div>
              ...
              <div className="w-full rounded-[8px] border p-4 bg-[#FBFAFA]" style={{ borderColor: "#21212114" }}>
                <div className="flex flex-col gap-2.5">
                  <InfoRow label="Title" value="Norem ipsum dolor sit amet" centerValue={false} />
                  <InfoRow label="Request description" value="Rorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc vulputate libero." centerValue={false} />
                </div>
              </div>
            </div>
          </div>
