...
import ItemRequestCard from "./item-request-card"

interface RoomDeliveryItem {
  id: string
  name: string
  image: string
  quantity: number
...
interface ViewRoomDeliveryModalProps {
  request: RoomDeliveryRequest | null
  isOpen: boolean
  onClose: () => void
}

export default function ViewRoomDeliveryModal({ request, isOpen, onClose }: ViewRoomDeliveryModalProps) {
        ...
        <div className="flex-1 p-5 overflow-y-auto">
          <div className="flex flex-col gap-3">
            ...
            <div>
              ...
              <div className="w-full rounded-[8px] border p-4 bg-[#FBFAFA]" style={{ borderColor: "#21212114" }}>
                <div className="flex flex-col gap-2.5">
                  <InfoRow label="Restaurant" value={request.restaurant} centerValue={false} />
                  <InfoRow label="Pick up" value={request.pickup} centerValue={false} />
                </div>
              </div>
            </div>
