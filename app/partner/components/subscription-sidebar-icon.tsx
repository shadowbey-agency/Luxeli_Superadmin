...
const SubscriptionSidebarIcon = ({ size = 24, strokeColor = "#141B34" }: SubscriptionSidebarIconProps) => (
  <div
    style={{
      display: "flex",
      width: "24px",
