...
interface ViewLaundryModalProps {
  request: LaundryRequest | null
  isOpen: boolean
  onClose: () => void
}

export default function ViewLaundryModal({ request, isOpen, onClose }: ViewLaundryModalProps) {
        ...
        <div className="flex-1 p-5 overflow-y-auto">
          <div className="flex flex-col gap-3">
            ...
            <div>
              ...
              <div className="w-full rounded-[8px] border p-4 bg-[#FBFAFA]" style={{ borderColor: "#21212114" }}>
                <div className="flex flex-col gap-2.5">
                  <InfoRow label="Service" value={request.service} centerValue={false} />
                  <InfoRow label="Piece" value={request.piece} centerValue={false} />
