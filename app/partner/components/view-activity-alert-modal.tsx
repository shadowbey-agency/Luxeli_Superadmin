...
interface ActivityAlertRequest {
  id: string
  requestId: string
  room: string
  guest: string
...
interface ViewActivityAlertModalProps {
  request: ActivityAlertRequest | null
  isOpen: boolean
  onClose: () => void
}

export default function ViewActivityAlertModal({ request, isOpen, onClose }: ViewActivityAlertModalProps) {
        ...
        <div className="flex-1 p-5 overflow-y-auto">
          <div className="flex flex-col gap-3">
            ...
            <div className="flex gap-4">
              {/* Left Card - Activity Card (same as activities page) */}
              <div 
              ...
              >
                ...
                {/* Activity Card - Same as activities page but read-only */}
                <ActivityCardView
                  id={parseInt(request.id) || 1}
                  title={request.title || "Activity Title"}
                  type={request.type || "Activity Type"}
                  location={request.location || "Location"}
                  date={request.created || "Jan 15, 2025"}
                  status={request.status || "Active"}
                  description={request.description || "Activity description goes here. Lorem ipsum dolor sit amet, consectetur adipiscing elit."}
