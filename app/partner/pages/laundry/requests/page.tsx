...
export default function LaundryRequestsPage() {
  ...
  // Export laundry requests to Excel
  const handleExportRequests = () => {
    ...
    XLSX.utils.book_append_sheet(workbook, worksheet, "Laundry Requests")
    ...
    const fileName = `laundry-requests-export-${new Date().toISOString().split('T')[0]}.xlsx`
