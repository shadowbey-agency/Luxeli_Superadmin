...
export default function ActivityAlertsRequestsPage() {
  ...
  // Export activity alert requests to Excel
  const handleExportRequests = () => {
    ...
    XLSX.utils.book_append_sheet(workbook, worksheet, "Activity Alerts")
    ...
    const fileName = `activity-alerts-export-${new Date().toISOString().split('T')[0]}.xlsx`
